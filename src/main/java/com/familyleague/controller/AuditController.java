...
public class AuditController {
    ...
    public ResponseEntity<com.familyleague.dto.response.ApiResponse<PagedResponse<AuditLogResponse>>> getLogsForRecord(
    ...
    public ResponseEntity<com.familyleague.dto.response.ApiResponse<PagedResponse<AuditLogResponse>>> getLogsByUser(
