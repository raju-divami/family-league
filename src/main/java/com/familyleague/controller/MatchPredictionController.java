...
public class MatchPredictionController {
    ...
    public ResponseEntity<com.familyleague.dto.response.ApiResponseDto<MatchPredictionResponse>> submit(
        ...
        return ResponseEntity.status(HttpStatus.CREATED).body(
                com.familyleague.dto.response.ApiResponseDto.ok("Prediction submitted",
    ...
    public ResponseEntity<com.familyleague.dto.response.ApiResponseDto<MatchPredictionResponse>> update(
            @Parameter(description = "Match ID") @PathVariable Long matchId,
            @Valid @RequestBody SubmitMatchPredictionRequest request,
            @AuthenticationPrincipal UserPrincipal principal) {
        return ResponseEntity.ok(com.familyleague.dto.response.ApiResponseDto.ok("Prediction updated",
    ...
    public ResponseEntity<com.familyleague.dto.response.ApiResponseDto<MatchPredictionResponse>> getMyPrediction(
            @Parameter(description = "Match ID") @PathVariable Long matchId,
            @AuthenticationPrincipal UserPrincipal principal) {
    ...
    public ResponseEntity<com.familyleague.dto.response.ApiResponseDto<List<MatchPredictionResponse>>> getAllPredictions(
            @Parameter(description = "Match ID") @PathVariable Long matchId,
            @AuthenticationPrincipal UserPrincipal principal) {
        return ResponseEntity.ok(com.familyleague.dto.response.ApiResponseDto.ok(
